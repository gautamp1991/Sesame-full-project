...
public class MyScreenRecorder extends ScreenRecorder {
	...
	public static void startRecording(String browserName,String className) throws Exception {
...
new Format(MediaTypeKey, MediaType.VIDEO, EncodingKey, "black", FrameRateKey, Rational.valueOf(30)),
				   null, file, browserName+ "-" +className);
	...
	public static void MoveRecFile(String value) {
		...
		File afile =new File(value);
			...
			if(afile.renameTo(new File("E:/Seasame Video/" + afile.getName()))){
